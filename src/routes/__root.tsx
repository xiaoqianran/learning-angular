...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Angular 实战学习 v3 · 系统路径",
      },
      {
        name: "description",
        content:
          "Angular 中文交互教程：对齐 angular.dev/llms.txt：清晰路径、文档地图、讲解+源码+Demo、Catppuccin 与全栈工坊。",
      },
    ],
    links: [
...
const CTP_BOOT =
  "(function(){try{var f=localStorage.getItem('angular-learn-ctp-flavor');var a=localStorage.getItem('angular-learn-ctp-accent');var okF=['mocha','macchiato','frappe','latte'];var okA=['green','mauve','blue','lavender','sapphire','teal','peach','pink'];if(okF.indexOf(f)<0)f='mocha';if(okA.indexOf(a)<0)a='pink';document.documentElement.setAttribute('data-ctp-flavor',f);document.documentElement.setAttribute('data-ctp-accent',a);}catch(e){document.documentElement.setAttribute('data-ctp-flavor','mocha');document.documentElement.setAttribute('data-ctp-accent','pink');}})();";
